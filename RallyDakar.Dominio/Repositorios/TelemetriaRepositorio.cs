...
namespace RallyDakar.Dominio.Repositorios
{
    public class TelemetriaRepositorio : ITelemetriaRepositorio
    {
        ...
        public void AdicionarTelemetria(Telemetria telemetria)
        {
            _rallyDbContexto.Add(telemetria);
        ...
        {
            return _rallyDbContexto.Telemetria.Any(t => t.Id == telemetriaId);
        }

        public Telemetria Obter(int telemetriaId)
        {
            return _rallyDbContexto.Telemetria.FirstOrDefault(t => t.Id == telemetriaId);
        }
